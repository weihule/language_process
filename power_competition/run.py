...
def run():
    predict_root_ = r"./data/天气预报数据/分布式功率预测天气预报数据-23年10月1日-10月7日"
    save_root_d1 = r"./data/outs/分布式12个区域未来7天功率预测"
    save_weight_root_d1 = r"./weights/dis1"
    mkdirs(save_root_d1)
    power(predict_root_, save_root_d1, save_weight_root_d1)

    pre_path_ = r"./data/天气预报数据/分布式发电量预测天气预报数据-22年11月-23年10月/FBS-SSRD-20221101-20231031.csv"
    save_root_d2 = r"./data/outs/分布式12个区域未来12个月发电量预测"
    save_weight_root_d2 = r"./weights/dis2"
    mkdirs(save_root_d2)
    energy(pre_path_, save_root_d2, save_weight_root_d2)

    forecast_root = r'./data/天气预报数据/集中式天气预报数据-23年10月1日到10月7日'
    save_root_c = r"./data/outs/集中式2个场群未来7天功率预测"
    save_weight_root_c = r"./weights/cen"
    mkdirs(save_root_c)
